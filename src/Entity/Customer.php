...
class Customer
{
     ...
     * @Assert\Length(min=5, minMessage="Le prénom doit faire entre 5 et 255 caratéres", max=255, maxMessage="Le prénom doit faire entre 5 et 255 caratéres")
     */
    private $firstName;
     ...
     * @Assert\Length(min=5, minMessage="Le nom doit faire entre 5 et 255 caratéres", max=255, maxMessage="Le nom doit faire entre 5 et 255 caratéres")
     */
    private $lastName;
